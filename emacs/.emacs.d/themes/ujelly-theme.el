...
(let ((class '((class color) (min-colors 89)))
      ...
      (custom-theme-set-faces
       ...
       `(company-preview-common ((,class (:foreground unspecified :background ,ujelly-purple-1))))
       ...
       `(lazy-highlight ((,class (:foreground ,ujelly-red-1 :background unspecified))))
       ...
       `(mode-line ((,class (:foreground ,ujelly-fg :background unspecified))))
       `(mode-line-inactive ((,class (:foreground ,ujelly-grey-4 :background unspecified))))
